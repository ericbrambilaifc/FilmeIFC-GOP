...
class SerieDao
{
    public static function inserir($dados)
    {
        ...
        $sql = "INSERT INTO Serie (titulo, diretor, elenco, ano,temporadas,  imagem, idcategoria, idclassificacao, detalhes, episodios ) 
                VALUES (:titulo, :diretor, :elenco, :ano, :temporadas, :imagem, :idcategoria, :idclassificacao, :detalhes, :episodios)";
